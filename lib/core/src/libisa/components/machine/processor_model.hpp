...
template <typename address_size_t, typename register_number_t, typename register_size_t, typename csr_number_t,
          typename csr_size_t, bool enable_history = true>
class ProcessorModel {
  public:
    ...
    virtual result<std::unique_ptr<components::delta::Base<register_number_t, register_size_t>>>
    take_register_delta() = 0;
