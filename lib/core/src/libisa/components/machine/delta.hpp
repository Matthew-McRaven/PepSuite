...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t>
                     &&components::storage::Integral<csr_val_t>) class StepDelta {
  public:
    using addr_delta_range =
        boost::iterator_range<decltype(((components::delta::Base<addr_size_t, addr_val_t> *)(0))->cbegin())>;
    using reg_delta_range =
        boost::iterator_range<decltype(((components::delta::Base<addr_size_t, addr_val_t> *)(0))->cbegin())>;
    using csr_delta_range =
        boost::iterator_range<decltype(((components::delta::Base<addr_size_t, addr_val_t> *)(0))->cbegin())>;
