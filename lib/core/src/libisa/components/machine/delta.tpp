...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t> &&components::storage::Integral<
                     csr_val_t>) void components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t,
                                                                     csr_count_t, csr_val_t>::apply_forward() {
...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t> &&components::storage::Integral<
                     csr_val_t>) void components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t,
                                                                     csr_count_t, csr_val_t>::apply_backward() {
...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t> &&components::storage::Integral<csr_val_t>)
    typename components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t,
                                            csr_val_t>::addr_delta_range
    components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t,
                                   csr_val_t>::memory_delta() const {
...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t> &&components::storage::Integral<csr_val_t>)
    typename components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t,
                                            csr_val_t>::reg_delta_range
    components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t,
                                   csr_val_t>::register_delta() const {
...
requires(components::storage::UnsignedIntegral<addr_size_t> &&components::storage::Integral<addr_val_t>
             &&components::storage::UnsignedIntegral<reg_count_t> &&components::storage::Integral<reg_val_t>
                 &&components::storage::UnsignedIntegral<csr_count_t> &&components::storage::Integral<csr_val_t>)
    typename components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t,
                                            csr_val_t>::csr_delta_range
    components::machine::StepDelta<addr_size_t, addr_val_t, reg_count_t, reg_val_t, csr_count_t, csr_val_t>::csr_delta()
        const {
