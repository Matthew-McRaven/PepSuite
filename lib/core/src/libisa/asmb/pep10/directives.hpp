...
template <typename address_size_t> class dot_export : public masm::ir::linear_line<address_size_t> {
  public:
    dot_export();
...
template <typename address_size_t> class dot_scall : public masm::ir::linear_line<address_size_t> {
  public:
    dot_scall();
...
template <typename address_size_t> class dot_uscall : public masm::ir::linear_line<address_size_t> {
  public:
    dot_uscall();
