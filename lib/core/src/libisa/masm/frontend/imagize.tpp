...
std::shared_ptr<masm::elf::top_level_section<address_size_t>>
text_to_image_helper(std::shared_ptr<masm::elf::image<address_size_t>> image,
                     std::shared_ptr<masm::project::source_file> prog, int header_index, std::string section_name) {
...
masm::frontend::text_to_image(std::shared_ptr<masm::project::project<address_size_t>> &project,
