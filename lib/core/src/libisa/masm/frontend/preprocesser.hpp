...
template <typename address_size_t, typename tokenizer_t> class preprocessor {
  public:
    struct flags {};
    preprocessor() {}
    preprocessor(const flags &flag) {}
    virtual ~preprocessor();
    virtual auto preprocess(std::shared_ptr<masm::project::project<address_size_t>> &project,
