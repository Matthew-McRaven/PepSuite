...
#ifndef EMSCRIPTEN
SECTION("Disallow multi-character arguments") { CHECK_THROWS(masm::ir::char_argument<uint16_t>("ab")); }
...
#ifndef EMSCRIPTEN
    SECTION("Disallow multi-character arguments") { CHECK_THROWS(masm::ir::string_argument<uint16_t>("abc")); }
    SECTION("Bad hex arguments") { CHECK_THROWS(masm::ir::string_argument<uint16_t>("\\xf")); }
#endif
}