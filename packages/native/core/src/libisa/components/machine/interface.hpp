...
struct TransactionLocker {
    TransactionLocker(MachineProcessorInterface<address_size_t, enable_history, val_size_t, memory_vector_t> &processor)
    ...
    ~TransactionLocker() { _processor.end_transaction(); }
...
struct InstructionLocker {
    InstructionLocker(MachineProcessorInterface<address_size_t, enable_history, val_size_t, memory_vector_t> &processor)
        : _processor(processor) {
    ...
    ~InstructionLocker() { _processor.end_instruction(); }
