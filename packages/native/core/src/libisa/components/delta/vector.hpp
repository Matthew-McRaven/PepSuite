...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>) class Vector
  ...
  public:
    ...
    template <class Iter> struct impl : components::delta::Base<offset_t, val_size_t>::Iterator::AIter {
