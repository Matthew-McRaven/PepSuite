...
template <> struct quick_status_code_from_enum<PepElfErrc> : quick_status_code_from_enum_defaults<PepElfErrc> {
    ...
    static const std::initializer_list<mapping> &value_mappings() {
        static const std::initializer_list<mapping> v = {
            ...
            {PepElfErrc::NoOSSymtab,
             "No os.symtab section was present in the provided image",
