...
masm::ir::ByteType asmb::pep10::unary_instruction::bytes_type() const { return masm::ir::ByteType::kCode; }
...
masm::ir::ByteType asmb::pep10::nonunary_instruction::bytes_type() const { return masm::ir::ByteType::kCode; }
