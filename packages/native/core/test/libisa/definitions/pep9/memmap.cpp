...
std::array<im, 256> instr_array = {
    ...
    im::RORA,  im::RORX,  im::BR,    im::BR,     im::BRLE,    im::BRLE,    im::BRLT,  im::BRLT,  im::BREQ, im::BREQ,
    im::BRNE,  im::BRNE,  im::BRGE,  im::BRGE,   im::BRGT,    im::BRGT,    im::BRV,   im::BRV,   im::BRC,  im::BRC,
    im::CALL,  im::CALL,  im::NOP0,  im::NOP1,

    im::NOP,   im::NOP,   im::NOP,   im::NOP,    im::NOP,     im::NOP,     im::NOP,   im::NOP,   im::DECI, im::DECI,
    im::DECI,  im::DECI,  im::DECI,  im::DECI,   im::DECI,    im::DECI,    im::DECO,  im::DECO,  im::DECO, im::DECO,
    im::DECO,  im::DECO,  im::DECO,  im::DECO,   im::HEXO,    im::HEXO,    im::HEXO,  im::HEXO,  im::HEXO, im::HEXO,
    im::HEXO,  im::HEXO,  im::STRO,  im::STRO,   im::STRO,    im::STRO,    im::STRO,  im::STRO,  im::STRO, im::STRO,
