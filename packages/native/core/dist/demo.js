...
pep10().then(function (instance) {
  var def = new instance.IsaDefinition(); //console.log(def.map)
  ...
  for (const [key, value] of Object.entries(instance.InstructionMnemonic.values)) {//console.log(key, def.isa.get(value).bit_pattern)
  }
