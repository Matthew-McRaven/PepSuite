cd ../dist
mv js-term-macos-x64 pepterm
chmod +x pepterm
codesign --deep --force --options=runtime --sign "6FC8F55BEFE887379900E3FC48E23469A453437B" --timestamp --entitlements ../entitlements.plist ./pepterm
rm -rf /tmp/pepterm
