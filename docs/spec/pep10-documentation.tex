...
There are no longer any awkward constant registers because any value can be loaded into any register from the control section over the D bus.
...
\begin{center}
\includegraphics{pep10-2-byte-bus.pdf}
\end{center}
