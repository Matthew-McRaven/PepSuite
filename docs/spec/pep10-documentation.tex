...
For the Pep/9 micro application, the microinstruction format now supports microcalls and microreturns made possible by a return address call stack in the control section.
...
Compared to the Pep/9 memory map, this map has several additional components -- a disk input port at address 5555, a shutdown port at address 6666, a dispatcher at address 7777, and a unary trap handler at address 9999.
